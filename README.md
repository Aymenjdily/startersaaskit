...
Source-available, not open source — see [LICENSE](LICENSE). You can read this
code, run it locally, and contribute to it; you cannot run it as a competing
service.

**Starters generated by it are a separate matter: they are yours outright.** No
licence from this project, no attribution, no restrictions — commercial work
included.
